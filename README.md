...
Веб приложение реализующее сервис по продаже билетов в кинотеатр.

Функционал:

- В приложении реализована регистрация пользователей.
- Учет купленных билетов. 
- Реализованы функции администратора: добавление,
